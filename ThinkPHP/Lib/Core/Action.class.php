   ...
   /**
    ...
    public function __construct() {
        ...
        if(method_exists($this,'_initialize'))
            $this->_initialize();
        //加载自定义语言包
        if(is_file(CONF_PATH.'lang.php'))
            $this->langZh=include CONF_PATH.'lang.php';
        $this->assign('langZh',$this->langZh);
        $this->assign("base_url",BASE_URL);
        //加载自定义配置包
        if(is_file(CONF_PATH.'base_config.php'))
            $this->base_config=include CONF_PATH.'base_config.php';
